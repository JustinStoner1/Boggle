...
public class Gui extends Application
{
  ...
  public void start(Stage primaryStage)
  {
    ...
    messageBox.setFont(Font.font("monoSpaced", FontWeight.NORMAL, 20));
    ...
    primaryStage.setScene(new Scene(window, tileSize*widthHeight, tileSize*widthHeight+45));
    primaryStage.show();
  }
